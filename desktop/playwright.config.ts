  ...
  projects: [
    {
      ...
      testMatch: [
        ...
        "**/dictation-transcript-scoping.spec.ts",
        ...
        "**/terminal-clipboard.spec.ts",
        "**/feedback.spec.ts",
        "**/worktree-switcher.spec.ts",
        "**/home-landing.spec.ts",
        "**/diff-base-picker.spec.ts",
        "**/worktree-history.spec.ts",
        "**/pinned-worktrees.spec.ts",
        "**/local-worktree-names.spec.ts",
        "**/worktree-list-lag.spec.ts",
