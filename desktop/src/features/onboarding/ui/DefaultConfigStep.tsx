...
function formatHarnessLabel(runtime: AcpRuntimeCatalogEntry | undefined) {
  ...
  // list beside Claude Code, Codex and Goose, and the bare product name read as
  // the name of the application the user is standing in — which is Vingilot.
  return runtime.id === "buzz-agent" ? "Buzz Agent" : runtime.label;
}
    ...
    >
      <div className="w-full max-w-[500px] text-center">
        ...
        <p className="mx-auto mt-3 max-w-[440px] text-sm leading-5 text-foreground/80">
          This will be set as your default model configuration across Vingilot.
