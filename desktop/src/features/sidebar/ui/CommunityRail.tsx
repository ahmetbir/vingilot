...
export function CommunityRail({
  ...
  return (
    <nav
      ...
      className="relative z-0 flex w-14 shrink-0 flex-col items-center gap-2.5 overflow-y-auto bg-transparent px-2.5 pb-5 pt-[calc(var(--buzz-top-chrome-height,44px)+7px)]"
