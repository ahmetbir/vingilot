...
/**
 * AppSidebar's props, out-of-line. The component file rides the 1000-line
 * ratchet (upstream grows it every release), and this 90-line type block is
 * the one part with no behavior in it — the honest split when the ratchet
 * trips, rather than compressing JSX the formatter would re-expand.
 */
