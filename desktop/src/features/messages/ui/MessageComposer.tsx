...
import { useComposerDictation } from "@/features/dictation/lib/useComposerDictation";
...
function MessageComposerImpl({
  ...
  // The composer's mic. Re-applied by hand after the upstream sync rewrote
  // this file around it: the sync extracted most of the composer into hooks,
  // so a patch of the fork's old shape no longer had anywhere to land. This is
  // the whole of what the fork adds here — everything else it used to carry in
  // this file is now upstream's own.
