...
export function SignOutSection() {
  ...
  return (
    <div className="mt-12 pb-6" data-testid="settings-signout">
      <SettingsOptionGroup
        description="Removes your identity key, the agent nest, and all local app data from this device. Before signing out, create and test a password-protected key backup above — this cannot be undone."
        headerAction={
          <Button
