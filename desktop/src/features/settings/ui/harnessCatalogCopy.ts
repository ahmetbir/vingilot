...
const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "buzz-agent": "The built-in agent runtime, bundled with the app.",
  ...
  cursor:
    "Cursor's coding agent, connected to Vingilot through its ACP server.",
  ...
  grok: "xAI's coding agent, connected to Vingilot through its ACP entrypoint.",
