// Domain types + pure view logic shared by the shell, the deck, and the run
// view. No coordinator-client or React imports here — this module is the
// thing api/coordinator.ts and every UI component agree on.
...
const LIVE: ReadonlySet<RunStatus> = new Set(["running", "verifying", "provisioning", "ready"]);
...
/** Groups runs for the rail. Exhaustive over every RunStatus by construction:
